...
class Verification:
    ...
    def valid_proof(transactions, last_hash, proof):
        """Validate a proof of work number
        and see if it solves the puzzle algorithm (two leading 0s)
        ...
        # It's a not a block's hash.
        # It's only used for the proof-of-work algorithm.
        guess_hash = hash_string_256(guess)
        # Only a hash (which is based on the above inputs)
        # which starts with two 0s is treated as valid
        # This condition is of course defined by you.
        # You could also require 10 leading 0s.

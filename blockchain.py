...
class Blockchain:
    ...
    def get_balance(self, sender=None):
        ...
        # spend coins before the transaction was confirmed
        # + included in a block
        tx_recipient = [
            [
                tx.amount for tx in block.transactions
    ...
    def mine_block(self):
        ...
        try:
            ...
            # Copy transaction instead of manipulating
            # the original open_transactions list
            # This ensures that if for some reason the mining should fail,
            # we don't have the reward transaction stored in open transactions
